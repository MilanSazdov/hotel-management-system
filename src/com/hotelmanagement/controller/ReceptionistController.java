...
public class ReceptionistController {
    ...
    private int nextReceptionistId;
    
    private ReceptionistController() {
        receptionistList = new ArrayList<>();
        loadReceptionistsFromFile();
        nextReceptionistId = receptionistList.size() > 0 ? receptionistList.get(receptionistList.size() - 1).getReceptionistId() + 1 : 1;
    }
    ...
    public void addReceptionist(Receptionist receptionist) {
    	receptionist.setReceptionistId(nextReceptionistId++);
        receptionistList.add(receptionist);
    ...
    public void updateReceptionist(Receptionist receptionist) {
        for (int i = 0; i < receptionistList.size(); i++) {
            if (receptionistList.get(i).getReceptionistId() == receptionist.getReceptionistId()) {
                receptionistList.set(i, receptionist);
                saveReceptionistsToFile();
                break;
            }
        }
